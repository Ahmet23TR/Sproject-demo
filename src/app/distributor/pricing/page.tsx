...
import { useDistributorPricing } from "@/hooks/distributor/useDistributorPricing";
...
export default function DistributorPricingPage() {
    ...
    const handleCreate = async () => {
        ...
        await onCreate(newName.trim(), "RETAIL"); // Default type is RETAIL
        setNewName("");
        setModalOpen(false);
    };
                                    ...
                                    <TableBody>
                                        {filtered.map((list) => (
                                            <TableRow
                                                ...
                                                onClick={() =>
                                                    router.push(
                                                        `/distributor/pricing/${encodeURIComponent(list.id)}`
                                                    )
                                                }
