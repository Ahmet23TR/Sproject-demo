...
interface PriceListRowProps {
    ...
    adminPrice?: { price?: number | null; multiplier?: number | null };
    onEditChange: (
        optionItemId: string,
...
export const PriceListRow = React.memo(
    ({ item, edit, adminPrice, onEditChange }: PriceListRowProps) => {
        ...
        return (
            <TableRow
                ...
                <TableCell>
                    {adminPrice?.price !== undefined && adminPrice?.price !== null
