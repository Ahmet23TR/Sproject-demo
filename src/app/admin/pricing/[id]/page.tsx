...
import { useAdminPriceListDetail } from "@/hooks/admin/useAdminPricing";
import { PriceListRow } from "./components/PriceListRow"; // Yeni bileşeni import et

export default function AdminPriceListDetailPage() {
    const params = useParams();
    const id = params.id as string;
    const { detail, saving, onSave, onSetDefault } =
        useAdminPriceListDetail(id);
