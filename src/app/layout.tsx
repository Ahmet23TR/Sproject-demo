...
export const metadata: Metadata = {
  ...
  description: "Streamline your catering operations with our all-in-one platform. From ordering to delivery, we've got you covered with premium quality service.",
};
